  ...
  <div class="wrapper ">
        ...
        <ul class="nav">
          <li class="nav-item ">
           ...
           <li class="nav-item active ">
            <a class="nav-link" href="user_administration.php">
    ...
    <div class="main-panel">
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title" align="center">Create new User</h4>
                </div>
                <div class="card-body">
      ...
      <?php
        ...
        {
          public function insertRecord($fname,$lname,$email,$role,$username,$password)
          {
            
            $con=$this->connect();

            $insert_query="insert into users values ('','$fname','$lname','$email','$role','$username','$password')";
        ...
        if(isset($regBtn))
        {
          $u->insertRecord($fname,$lname,$email,$role,$username,$password);
